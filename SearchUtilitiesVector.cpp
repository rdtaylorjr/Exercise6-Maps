/**
 ...
 @file SearchUtilitiesVector.cpp
...
int recSeqSearchActual(vector<int> list, int listLength, int searchItem, int &count) {
...
int recBinarySearchActual(vector<int> list, int listLength, int searchItem, int first, int last, int &count) {
    count++;
    if (first > last)
        return -1;
    else {
